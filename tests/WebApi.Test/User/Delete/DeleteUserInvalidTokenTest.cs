...
public class DeleteUserInvalidTokenTest : EvolutioClassFixture
{
    ...
    public async Task Error_Token_Invalid()
    {
        ...
        var response = await DoDelete(method: $"{METHOD}/{_userId}", token: "invalidToken");
    ...
    {
        var request = RequestUpdateUserJsonBuilder.Build();
        var response = await DoDelete(method: $"{METHOD}/{_userId}", token: string.Empty);
    ...
    public async Task Error_Token_With_User_NotFound()
    {
        ...
        var response = await DoDelete(method: $"{METHOD}/{_userId}", token: token);
